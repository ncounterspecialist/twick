...
export function RectPanel() {
  ...
  return (
    <div className="w-72 bg-neutral-800/80 border-l border-gray-600/50 p-4 overflow-y-auto overflow-x-hidden backdrop-blur-md shadow-lg">
      <h3 className="text-xl font-bold text-white mb-6">Rectangle</h3>

      {/* Corner Radius */}
      <div className="mb-6">
        <label className="block text-sm font-semibold text-gray-300 mb-2">Corner Radius</label>
        <div className="flex items-center gap-3">
          ...
          />
          <span className="text-white text-sm font-medium min-w-[50px]">{cornerRadius}px</span>
        </div>
      </div>
