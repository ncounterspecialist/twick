import { TIMELINE_ELEMENT_TYPE, TIMELINE_OPERATION, useTimelineContext, type TimelineElement } from "@twick/timeline";
...
const TextEffectPanel = () => {
  ...
  const handleSetTextEffect = () => {
    ...
    setTimelineOperation(TIMELINE_OPERATION.SET_TEXT_EFFECT, {
