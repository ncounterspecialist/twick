...
export class TimelineService {
  ...
  editCaptionProps = ({
    ...
    return this.captionService.editCaptionProps({
      timelineId,
      elementId,
      updates,
      captionProps,
  ...
  getTimelineProps(timelineId: string): any {
    return this.dataService.getTimelineProps(timelineId);
  }
  ...
  updateMaps(timeline: Timeline[]): void {
    // This method is no longer needed as the data service manages maps internally
